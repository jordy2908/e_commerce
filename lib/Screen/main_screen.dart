...
import 'package:jobec/components/job_carousel.dart';
import 'package:jobec/components/job_list.dart';
  ...
  List<Job> forYouJobs = [
    ...
    Job(
      ...
      company: Company(
        name: 'Amazon',
        urlLogo:
            'https://pbs.twimg.com/profile_images/651407766926462976/eI3jEBZW_400x400.png',
      ),
    ),
  ];
